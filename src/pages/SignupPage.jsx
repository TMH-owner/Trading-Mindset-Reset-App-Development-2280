...
const { FiUser, FiMail, FiLock, FiEye, FiEyeOff, FiArrowRight, FiPhone } = FiIcons;
    ...
    >
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-calm-900 mb-2">Join Trader Mindset Hub</h2>
          <p className="text-calm-600">Start your journey to trading mastery</p>
        </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors ${
                    errors.name ? 'border-red-300' : 'border-calm-300'
                  }`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors ${
                    errors.phone ? 'border-red-300' : 'border-calm-300'
                  }`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors ${
                    errors.confirmPassword ? 'border-red-300' : 'border-calm-300'
                  }`}
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="agree" className="text-calm-700">
                  I agree to the{' '}
